...
from scratchpad.server.args import global_args, ServerArgs
...
from scratchpad.utils import get_processor, get_tokenizer
...
from scratchpad.scheduler.policy_scheduler import PolicyScheduler, PrefillAdder
...
class ModelTpServer:
    def __init__(
        ...
        self.min_new_token_ratio = min(
            global_args.base_min_new_token_ratio
            * server_args.schedule_conservativeness,
            1.0,
        )
        self.new_token_ratio = self.min_new_token_ratio
        self.new_token_ratio_decay = global_args.new_token_ratio_decay
    ...
    def forward_step(self):
        ...
        if new_batch is not None:
            ...
            if self.running_batch is not None:
                ...
                for _ in range(global_args.num_continue_decode_steps):
                ...
                self.check_memory()
                self.new_token_ratio = global_args.init_new_token_ratio
