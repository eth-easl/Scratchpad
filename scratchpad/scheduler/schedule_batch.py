...
from scratchpad.utils import envs, logger, flatten_nested_list, get_compiler_backend
...
class ScheduleBatch:
    ...
    def prepare_for_extend(self):
        ...
        if global_args.attention_backend != "torch_native":
    ...
    def prepare_for_decode(self, topping_manager: Optional["ToppingsManager"] = None):
    ...
    def get_model_worker_batch(self) -> "ModelWorkerBatch":
        ...
        return ModelWorkerBatch(
            ...
            toppings_paths=[req.topping_path for req in self.reqs],
...
class ModelWorkerBatch:
    ...
    # For LoRA/Delta/Full
    toppings_paths: Optional[List[str]]
