...
from scratchpad.nn.quantization.base_config import (
    QuantizationConfig,
    QuantizeMethodBase,
    method_has_implemented_embedding,
)
from scratchpad.nn.parameter import BasevLLMParameter
...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def weight_loader(self, param: Parameter, loaded_weight: torch.Tensor):
        ...
        if packed_dim is not None and packed_dim == output_dim:
            ...
            ), f"Expect loaded weight shape {loaded_weight.shape[output_dim]} == {self.org_vocab_size}, got {loaded_weight.shape[output_dim]} != {self.org_vocab_size}"
