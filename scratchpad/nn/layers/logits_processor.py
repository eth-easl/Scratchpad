...
from scratchpad.model_executor.forward_info import (
    ForwardMode,
    ForwardBatch,
    CaptureHiddenMode,
)
...
class LogitsMetadata:
    ...
    def from_forward_batch(cls, forward_batch: ForwardBatch):
        if (
            ...
            ) = extend_token_ids_logprob = extend_logprob_pruned_lens_cpu = False
...
class LogitsProcessor(nn.Module):
    ...
    def compute_temp_top_p_normalized_logprobs(
        ...
        if (
            ...
            from .sampler import top_p_normalize_probs_torch
