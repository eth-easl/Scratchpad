...
import torch
from flashinfer.sampling import _to_tensor_scalar_tuple
...
def _top_k_renorm_probs_internal(
    ...
    renorm_probs = fis.top_k_renorm_probs(probs, maybe_top_k_arr, top_k_val)
    return renorm_probs
...
def _top_p_renorm_probs_internal(
    ...
    renorm_probs = fis.top_p_renorm_probs(probs, maybe_top_p_arr, top_p_val)
    return renorm_probs
...
def _top_p_sampling_from_probs_internal(
    ...
    with probs.device as device:
        ...
        samples = fis.top_p_sampling_from_probs(
            probs,
            indices,
            maybe_top_p_arr,
            top_p_val,
...
def _top_k_top_p_sampling_from_probs_internal(
    ...
    with probs.device as device:
        ...
        samples = fis.top_k_top_p_sampling_from_probs(
            probs,
            top_k_val,
            top_p_val,
            indices,
...
def _min_p_sampling_from_probs_internal(
    ...
    with probs.device as device:
        ...
        samples = fis.min_p_sampling_from_probs(
            probs,
            indices,
            maybe_min_p_arr,
            min_p_val,
