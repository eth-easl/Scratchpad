...
class LlamaMoE(nn.Module):
    def __init__(
        ...
        self.experts = nn.ModuleList(
            [sparse_low_precision_linear(input_size, output_size) for _ in range(num_experts)]
        )
...
class LlamaNaiveQuantisedBTCForCausalLM(nn.Module):
    def __init__(
        self,
        config: LlamaConfig,
        quant_config: Optional[QuantizationConfig] = None,
...
EntryClass = [LlamaNaiveQuantisedBTCForCausalLM]
