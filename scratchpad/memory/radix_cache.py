...
from .base_prefix_cache import BasePrefixCache
from .pool import ReqToTokenPool, TokenToKVPoolAllocator
...
def _key_match_page_size_1(key0: List, key1: List):
    i = 0
...
class RadixCache(BasePrefixCache):
    def __init__(
        ...
        if self.page_size == 1:
            self.key_match_fn = _key_match_page_size_1
