...
class TestScaledActivation(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            self.scaled_activation.input_is_parallel, self.input_is_parallel
        )
    ...
    def test_forward(self):
        ...
        expected_output = (
            self.act_module(self.input_tensor) / self.scaled_activation.scales
        )
    ...
    def test_weight_loader(self):
        ...
        self.scaled_activation.weight_loader(
            self.scaled_activation.scales, loaded_weight
        )
        self.assertTrue(
            torch.allclose(self.scaled_activation.scales.data, loaded_weight, atol=1e-6)
        )
